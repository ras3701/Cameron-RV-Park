...
urlpatterns = [
    ...
    path('bookings/approved/', views.viewuserapprovedbookings, name='viewuserapprovedbookings'),
    path('bookings/unapproved/', views.viewuserunapprovedbookings, name='viewuserunapprovedbookings'),
